...
class ChatService:
                    ...
                    if settings.verify_answer_enabled:
                        ...
                        yield {
                            ...
                            "data": _build_verify_payload(
                                verify_result, replacement_answers=replacement
                            ),
                        }
    ...
    async def _persist_user_message(
        ...
        if await repo.count_messages(state["conversation_id"]):
    ...
    async def _persist_assistant_message(
        ...
        if verify_result is not None:
            ...
            extra_medata["verify_result"] = _build_verify_payload(
                verify_result, replacement_answers=None
            )
...
def _build_verify_payload(
        result: VerifyResult, *, replacement_answers:str | None
) -> dict:
    ...
    if not result.verified and replacement_answers is not None:
        payload["replacement_answers"] = replacement_answers
    return payload
